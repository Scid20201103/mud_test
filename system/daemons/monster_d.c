...
nosave mixed mob_info = ({
    ...
    ({"trigertaur", "***兵", "Beast", 100, 12, 98, 100, 85, 350, 136}),
    ...
    ({"cheeky tiki", "***提基", "Material", 117, 9, 107, 127, 100, 660, 100}),
    ...
    ({"sick trigertaur", "狮***士", "Beast", 480, 32, 208, 222, 156, 3600, 195}),
    ...
    ({"boogie manguini", "***撒旦", "Demon", 488, 20, 402, 478, 393, 5230, 149}),
